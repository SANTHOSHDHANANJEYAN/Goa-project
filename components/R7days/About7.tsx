...
export default function About7() {
  ...
  return (
   <section className="relative bg-white overflow-hidden pt-16 pb-12 px-6 sm:px-10 max-w-7xl mx-auto">
  <div
    className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center relative z-10"
    ref={sectionRef}
  >
    {/* Left Text Content */}
