      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700">
            Ready to embark on your yoga journey? Contact us to reserve your spot or ask any questions
          </p>
        </div>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="bg-[#6077ba] p-8 md:p-12 text-white">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-100">
                        Rishikul Yogshala<br />
                        Mandrem Beach, Goa<br />
                        India - 403527
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-100">info@rishikulyogshala.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-100">+91 8888-12345</p>
                    </div>
                  </div>
                </div>
                ...
                {/* <div className="mt-12">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-[#120b62] hover:bg-emerald-500 p-2 rounded-full transition-colors">
              ...
              <div className="p-8 md:p-12">
                ...
                <p className="mt-6 text-sm text-gray-600">
                  By submitting this form, you agree to our <a href="#" className="text-emerald-600 hover:underline">privacy policy</a> and <a href="#" className="text-emerald-600 hover:underline">terms of service</a>.
                </p>
              </div>
            </div>
          </div>
