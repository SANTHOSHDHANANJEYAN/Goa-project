    ...
    <>
      <header
        className={cn(
          ...
          scrolled ? "translate-y-[-100%] lg:translate-y-[-44px]" : "translate-y-0"
        )}
      >
        {/* Top Header Bar */}
        <div 
          className={cn(
            "w-full bg-[#ffe4c4] text-[#1F2937] py-2 sm:py-2.5 px-2 sm:px-4 transition-all duration-300",
            scrolled && "lg:block hidden"
          )}
        >
              ...
              <div className="flex items-center gap-2 sm:gap-4 lg:gap-12">
                ...
                <nav className="hidden lg:flex items-center gap-4 xl:gap-6 text-xs xl:text-sm font-medium text-[#1F2937]">
                  <div className="relative dropdown-container">
                    <button
                      onMouseEnter={() => setDesktopDropdown("Program")}
                      onClick={() => setDesktopDropdown(desktopDropdown === "Program" ? null : "Program")}
                    ...
                    {desktopDropdown === "Program" && (
                      <div 
                        className="absolute top-full left-0 mt-1 w-56 xl:w-64 bg-white border border-gray-200 border-b-4 border-[#E0B973] rounded-md shadow-lg z-50"
                  ...
                  <div className="relative dropdown-container">
                    <button
                      onMouseEnter={() => setDesktopDropdown("Retreat")}
                      onClick={() => setDesktopDropdown(desktopDropdown === "Retreat" ? null : "Retreat")}
                      className="flex items-center gap-1 hover:text-[#E0B973] transition-colors py-2"
                    >
                      RETREATS
                      <ChevronDown
