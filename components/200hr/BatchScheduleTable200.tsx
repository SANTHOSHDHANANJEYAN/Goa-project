...
const CourseSchedule = () => {
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-[#fff9eb] to-[#fffef8] py-16 px-6 md:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex justify-center">
              <Image
                src="/images/certificate-goa.jpg" // replace with your certificate image path
                alt="Yoga TTC Certificate"
                width={600}
                height={400}
            ...
            <div className="flex justify-center">
              <Image
                src="/images/group-goa.jpg" // replace with your group photo path
