        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              className="hidden md:flex absolute -left-4 top-1/2 -translate-y-1/2 z-10 h-12 w-12 bg-white/90 hover:bg-white shadow-lg rounded-full justify-center items-center ring-1 ring-[#150e70]/20 hover:ring-[#150e70]/40 transition"
            >
              <ChevronLeft className="w-6 h-6 text-[#150e70]" />
            </button>
            <button
              onClick={() => scrollByAmount('right')}
              className="hidden md:flex absolute -right-4 top-1/2 -translate-y-1/2 z-10 h-12 w-12 bg-white/90 hover:bg-white shadow-lg rounded-full justify-center items-center ring-1 ring-[#150e70]/20 hover:ring-[#150e70]/40 transition"
            >
              <ChevronRight className="w-6 h-6 text-[#150e70]" />
            </button>

            {/* Equal Height Scroll Cards */}
            <div
              ref={sliderRef}
              className="flex gap-5 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-3 px-1 scrollbar-hide"
            >
              {books.map((book, idx) => (
                <div key={idx} className="snap-start min-w-[220px] sm:min-w-[260px] md:min-w-[280px] lg:min-w-[300px] flex-shrink-0">
