...
<section className="py-16 px-6 md:px-20 bg-white">
  <div className="max-w-7xl mx-auto">
    ...
    <h2 className="text-3xl md:text-4xl font-semibold text-black mb-12 text-center">
      Best 50 Hour Yoga Teacher Training in Goa
    </h2>
    ...
    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
      ...
      <div className="flex flex-col h-full">
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <p>
            Our 50 Hour Yoga Teacher Training Program in Goa is a wonderful opportunity for beginner Yoga Practitioners.
            We at Rishikul Yogshala offer a comprehensive 50 Hour Yoga Teacher Training Course in Goa for students who
            want to begin their Yogic Journey. The 50 hours Yoga Teacher Training Program is a Multi Style - Multi Faceted
          ...
          <p>
            ...
            our 50 hour Yoga Alliance teacher training in Goa, is curated in such a way, that it may stand out from others
            and become the best platform for the beginners and the intermediate practitioners.
          </p>

          <p>
            While you dedicate your valuable time in 50 Hour Yoga Teacher Training Course, it becomes our responsibility
      ...
      <div className="flex flex-col h-full gap-16 md:gap-10">
        ...
        <div className="relative w-full flex justify-center">
          <a
            ...
            className="group block relative overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.1)] border border-gray-50 bg-black rounded-xl"
            aria-label="Open the Instagram Reel in a new tab"
          >
            {/* Portrait Thumbnail — show actual image size */}
            <img
              src="/aboutpics/about50.jpg"
              alt="Instagram Reel: 50 Hour Yoga Teacher Training in Goa"
  ...
  <div className="relative max-w-4xl mx-auto py-16 px-4 md:px-10 text-center">
    <div className="bg-white/50 rounded-lg shadow-md p-8 md:p-12 backdrop-blur-md">
      <h2 className="text-xl md:text-2xl font-semibold text-black mb-4 tracking-wide uppercase">
        50 Hour Yoga Teacher Training Curriculum
      </h2>
