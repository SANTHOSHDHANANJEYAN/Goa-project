            ...
            <div className="pt-2">
              <Link href="/contact">
                <motion.button
                  ...
                  whileTap={{ scale: 0.97 }}
                  className="bg-gradient-to-r from-[#150e70] to-[#1f2d98] hover:bg-green-700 transition text-white px-10 py-3 rounded-full shadow-lg text-sm sm:text-base font-semibold w-full sm:w-auto"
                >
                  BOOK NOW
                </motion.button>
              </Link>
