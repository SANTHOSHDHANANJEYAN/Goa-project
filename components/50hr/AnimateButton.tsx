...
>
  ...
  <div className="relative z-10 w-full text-center px-4 mt-10">
    ...
    <h1 className="text-lg sm:text-xl md:text-2xl font-semibold leading-relaxed font-sans mb-6">
    ...
    {/* Stats Grid */}
    <div className="mt-6 w-full max-w-xl mx-auto grid grid-cols-1 gap-6 bg-black bg-opacity-40 rounded-xl p-6 text-sm sm:text-base font-medium">
