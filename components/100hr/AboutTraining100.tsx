    ...
    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-stretch">
      ...
      <div className="flex flex-col h-full">
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <p>
            Our 100 Hour Yoga Teacher Training Program in Goa is a wonderful opportunity for beginner Yoga Practitioners.
            We at Rishikul Yogshala offer a comprehensive 100 Hour Yoga Teacher Training Course in Goa for students who
            want to begin their Yogic Journey. The 100 hours Yoga Teacher Training Program is a Multi Style - Multi Faceted
          ...
          <p>
            ...
            our 100 hour Yoga Alliance teacher training in Goa, is curated in such a way, that it may stand out from others
            and become the best platform for the beginners and the intermediate practitioners.
          </p>

          <p>
            While you dedicate your valuable time in 100 Hour Yoga Teacher Training Course, it becomes our responsibility
