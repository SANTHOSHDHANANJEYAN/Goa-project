  ...
  return (
    <section className="bg-white py-12 px-5 sm:px-8 lg:px-16 text-[#262626] font-sans">
      <div className="max-w-5xl mx-auto space-y-8">
        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl font-bold text-black text-center leading-snug">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="border border-gray-100 shadow-sm rounded-xl p-5 hover:shadow-md transition">
            <h3 className="text-xl font-semibold text-black mb-3">Week 1: Foundations</h3>
          ...
          <div className="border border-gray-100 shadow-sm rounded-xl p-5 hover:shadow-md transition">
            <h3 className="text-xl font-semibold text-black mb-3">Week 2: Balance & Alignment</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm sm:text-base">
          ...
          <div className="border border-gray-100 shadow-sm rounded-xl p-5 hover:shadow-md transition">
            <h3 className="text-xl font-semibold text-black mb-3">Week 3: Inner Transformation</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm sm:text-base">
        ...
        <div className="border-t border-gray-200 pt-8">
          <h3 className="text-xl font-semibold text-black mb-3">Special Sessions</h3>
          <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm sm:text-base">
        ...
        {/* Syllabus */}
        <div className="border-t border-gray-200 pt-8">
          <h3 className="text-xl font-semibold text-black mb-5">Detailed Syllabus</h3>

          <div className="grid md:grid-cols-2 gap-6 text-gray-700 text-sm sm:text-base">
            <div className="bg-gray-50 rounded-lg p-5">
              <h4 className="font-semibold text-black mb-2">Day 1–3: Introduction & Foundations</h4>
            ...
            <div className="bg-gray-50 rounded-lg p-5">
              <h4 className="font-semibold text-black mb-2">Day 4–7: Balance & Alignment</h4>
              <ul className="list-disc list-inside space-y-1">
            ...
            <div className="bg-gray-50 rounded-lg p-5">
              <h4 className="font-semibold text-black mb-2">Day 8–14: Inner Transformation</h4>
              <ul className="list-disc list-inside space-y-1">
            ...
            <div className="bg-gray-50 rounded-lg p-5">
              <h4 className="font-semibold text-black mb-2">Day 15–21: Integration & Application</h4>
              <ul className="list-disc list-inside space-y-1">
