...
const InclusionsExclusionsSection: React.FC = () => {
  const inclusions = [
    ...
    },
    {
      ...
      text: "300 Hour YTT Course Certification"
    }
  ];
          ...
          >
            ...
            >
              {inclusions.map((item, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-green-300 rounded-full flex items-center justify-center text-green-600 mt-0.5">
                    {item.icon}
                  </div>
          ...
          >
            ...
            >
              {exclusions.map((item, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 bg-red-300 rounded-full flex items-center justify-center text-red-600 mt-0.5">
                    {item.icon}
                  </div>
                  <p className="text-gray-700 flex-1 leading-relaxed">
                    {item.text}
