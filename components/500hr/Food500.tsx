  ...
  return (
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center bg-white shadow-lg rounded-2xl p-8 text-left">
      ...
      <div className="relative w-full h-full flex justify-center items-center">
        ...
        />
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-black/10 to-transparent opacity-0 hover:opacity-500 transition-opacity duration-500" />
      </div>
      ...
      <div>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          ...
          In <strong>500 Hours Yoga Teacher Training In Goa</strong>, healthy and delicious vegetarian meals made
