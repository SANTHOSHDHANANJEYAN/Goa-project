...
export default function Accommodation500() {
  ...
  <div className="container mx-auto px-4 mb-12">
    ...
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center mb-16">
            ...
            {accommodationFeatures.map((feature, index) => (
              <li key={index} className="flex items-start">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 500-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                    clipRule="evenodd"
                  />
                </svg>
      ...
      <div className="relative w-full h-full flex justify-center items-center">
        ...
        />
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-black/10 to-transparent opacity-0 hover:opacity-500 transition-opacity duration-500"></div>
      </div>
    </div>
  </div>
      ...
      >
        {roomImages.map((image, index) => (
          <SwiperSlide key={index}>
            <div
              className="relative rounded-2xl overflow-hidden group shadow-lg cursor-pointer transform transition-all duration-500 hover:shadow-xl"
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-500 transition-opacity duration-500" />
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
