  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-[#f8faff] to-white pb-[4rem] text-center overflow-hidden">
      ...
      >
        ...
        >
          Plus 5 free video lessons to discover the fundamental principles of
          creating your own yoga class and the essential tools for teaching.
        </motion.p>
