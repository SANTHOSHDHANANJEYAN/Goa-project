        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pd-[2rem]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">123 Serenity Lane,<br />Mindful Valley, CA 94123</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@houseofom.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Monday - Friday: 6:00 AM - 9:00 PM<br />
                    Saturday - Sunday: 8:00 AM - 7:00 PM</p>
                  </div>
                </div>
              </div>
            ...
            <div className=" rounded-lg p-8">
              ...
              {isSuccess ? (
                <div className="bg-accent/10 border border-accent/20 text-accent rounded-lg p-4 mb-6">
