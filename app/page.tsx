            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-center md:text-left">
              ...
              <div>
                <h3 className="text-2xl text-[#150e70] font-medium mb-6">
                  Since 2009, students from around the world have been joining our programs and earning their Yoga Alliance accredited
                  certifications.
                </h3>
        ...
        <section className="relative py-20 text-center bg-transparent">
          <div className="max-w-5xl mx-auto px-6 z-10 relative">
            ...
            <p className="text-lg text-gray-900 dark:text-gray-400 mb-10 animate-slide-up animation-delay-400">
              We don’t teach what to think — we open paths to explore who you truly are. With students and teachers from around
              the globe, each journey here is deeply personal. Whether you’re just beginning or have walked this path for years,
              you belong.
            </p>
