...
import Accommodation50 from "@/components/50hr/Accomodations50";
import Food50 from "@/components/50hr/Food50";
// Lazy imports
const TestimonialCarousel = dynamic(() => import("@/components/testimonials-section"));
const FAQSection = dynamic(() => import("@/components/FAQSection"));
const AboutTraining50 = dynamic(() => import("@/components/50hr/AboutTraining50"));
const CurriculumSection50 = dynamic(() => import("@/components/50hr/CurriculumSection50"));
const ActivitiesSection50 = dynamic(() => import("@/components/50hr/ActivitiesSection50"));
const BatchScheduleTable50 = dynamic(() => import("@/components/50hr/BatchScheduleTable50"));
const TestimonialSection50 = dynamic(() => import("@/components/50hr/TestimonialSection50"));
const YogaHighlights50 = dynamic(() => import("@/components/50hr/YogaHighlights50"));
const ApplicationForm50 = dynamic(() => import("@/components/50hr/ApplicationForm50"));
const TeachersSection50 = dynamic(() => import("@/components/50hr/TeachersSection50"));
const Schedule50 = dynamic(() => import("@/components/50hr/Schedule50"));
...
<section className="bg-white p-8 min-h-screen flex flex-col items-center">
  ...
  <div className="flex flex-col md:flex-row gap-10 w-full max-w-5xl">
    ...
    {/* <FAQSection
      ...
      faqs={[
        {
          question: "1. Who can join the 50-hour YTTC?",
        ...
        {
          question: "3. What are the benefits of completing the 50-hour YTTC?",
